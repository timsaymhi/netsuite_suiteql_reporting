/*
This script is attached to the form of the Saved SQLSearch custom record 
under "Custom Code"

Set Field Changed Function to "loadFilters"
*/

function loadFilters(type, name) {
	if (name === 'custrecordsql_query') {
		showAlertBox('INFO','Parsing SQL File for Filters', 'Please Wait...');
