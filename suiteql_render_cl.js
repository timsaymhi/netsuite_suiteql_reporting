...
function openFolder(folderId) {
	var cUrl = nlapiResolveURL('suitelet',nlapiGetFieldValue('custpage_scriptid'),nlapiGetFieldValue('custpage_deployid'), true);
	var cUrlA = cUrl.split('.');
	var url = cUrlA[0] + '.app.netsuite.com/app/common/custom/custrecordentrylist.nl?rectype=' + folderId
