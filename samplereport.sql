...
left join (select revenueplan, amount, dateexecuted, plannedperiod, postingperiod from revenuePlanPlannedRevenue) prs on rp.id = prs.revenueplan and prs.plannedperiod = ? /*accountingperiod*/
...
where rp.revenueplantype = 'ACTUAL'  and r.elementdate > ? /*date*/ order by r.elementdate
